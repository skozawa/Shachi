...
sub get_record : Tests {
    ...
    subtest 'get record' => sub {
        ...
        my $metadata_list = Shachi::Model::List->new(list => [ map {
            ...
            { name => 'relation', value_id => create_metadata_value(value => 'isVersionOf')->id, description => 'T-000003: test corpus' },
            { name => 'relation', value_id => create_metadata_value(value => 'hasVersion')->id, description => 'T-000007: test corpus 2' },
            { name => 'relation', value_id => create_metadata_value(value => 'isReplacedBy')->id, description => 'T-000002: old test corpus' },
            { name => 'relation', value_id => create_metadata_value(value => 'replaces')->id, description => 'corpus for replace' },
            { name => 'relation', value_id => create_metadata_value(value => 'isRequiredBy')->id, description => 'D-000009: dictionary' },
            { name => 'relation', value_id => create_metadata_value(value => 'requires')->id, description => 'D-000011: dic' },
            { name => 'relation', value_id => create_metadata_value(value => 'isPartOf')->id, description => 'part thesaurus' },
            { name => 'relation', value_id => create_metadata_value(value => 'hasPart')->id, description => 'D-000012: dictionary version2' },
            { name => 'relation', value_id => create_metadata_value(value => 'isReferencedBy')->id, description => 'http://example.com/' },
            { name => 'relation', value_id => create_metadata_value(value => 'references')->id, description => 'refer' },
            { name => 'relation', value_id => create_metadata_value(value => 'isFormatOf')->id, description => 'dic format' },
            { name => 'relation', value_id => create_metadata_value(value => 'hasFormat')->id, description => 'format' },
            { name => 'relation', value_id => create_metadata_value(value => 'conformsTo')->id, description => 'conforms' },
